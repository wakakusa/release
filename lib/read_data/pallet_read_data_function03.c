...
G_MODULE_EXPORT void Read_CSVfile_chooserdialog2_FileOpen_OK (GtkWidget *widget,gpointer data  )
{
 //読み込み対象ファイル名を取得
  ...
  (Pallet_Read_Data.script1) =g_strconcat(Pallet_Read_Data.object_name,"<-read.table(\"",Pallet_Read_Data.file1,"\",header=",Pallet_Read_Data.TF_flag1,",sep =\";\",dec=\",\",skip=",Pallet_Read_Data.skip,",comment.char=",Pallet_Read_Data.comment_char,",row.names=",Pallet_Read_Data.row_names,");\n",NULL);
