 ...
 * glade:
 **********************************************************************************************/
void create_pallet10(StructPalletWidget *struct_widget,char UI_FILE[256],char Window_name[512])
{
 GtkBuilder *builder;
  GError* error = NULL;
 ...
 * glade:none
 **********************************************************************************************/
G_MODULE_EXPORT void Read_filechooserdialog10_FileOpen_OK (GtkWidget *widget,gpointer data  )
{
 ...
 * glade:
 **********************************************************************************************/
G_MODULE_EXPORT void cb_read_data_function10_for_terminal(GtkWidget *widget, gpointer data)
{
  gchar *script;
  g_free(script);	
...
G_MODULE_EXPORT void cb_read_data_function10_for_editor(GtkWidget *widget, gpointer data)
{
  gchar *script;
  g_free(script);	
