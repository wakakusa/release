...
G_MODULE_EXPORT void create_workdirectory_chooserdialog_FileOpen_OK (GtkWidget *widget,gpointer data  )
{
  ...
  (Pallet_Operation.script1) = g_strconcat("cd(\"",Pallet_Operation.file1,"\")\n",NULL);
 ...
 * glade:workdirectory_chooserdialog
*****************************************************************************************************/
G_MODULE_EXPORT void cb_basic_function1_for_terminal(GtkWidget *widget, gpointer data)
{
  create_workdirectory_chooserdialog(&Pallet_Operation,PalletInterfaceFile01,"workdirectory_chooserdialog");
 ...
 * glade:workdirectory_chooserdialog
*****************************************************************************************************/
G_MODULE_EXPORT void cb_basic_function1_for_editor(GtkWidget *widget, gpointer data)
{
  create_workdirectory_chooserdialog(&Pallet_Operation,PalletInterfaceFile01,"workdirectory_chooserdialog");
  gtk_dialog_run(GTK_DIALOG(Pallet_Operation.window1));
  gtk_widget_destroy(Pallet_Operation.window1);
