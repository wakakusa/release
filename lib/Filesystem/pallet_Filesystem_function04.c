...
*****************************************************************************************************/
void create_loadfile_chooserdialog(StructPalletFilesystemWidget *struct_widget,char UI_FILE[PATH_LENGTH],char Window_name[512])
{
  GtkBuilder *builder;
  GError* error = NULL;
...
G_MODULE_EXPORT void create_loadfile_chooserdialog_FileOpen_OK (GtkWidget *widget,gpointer data  )
{
  ...
  (Pallet_Filesystem.script1)= g_strconcat("load(\"",Pallet_Filesystem.file_path1,"\")\n",NULL);
